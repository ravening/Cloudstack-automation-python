...
def handleArguments(argv):
    ...
    help = "Usage: ./" + os.path.basename(__file__) + ' [options] ' + \
        ...
        '\n  --account-name -a \t\t\tDisplay the information related to the account name' + \
    ...
    try:
        opts, args = getopt.getopt(
                argv, "hc:d:a:p", [
                "config-profile=", "display=", "debug", "exec", "account-name="])
...
# get users
userData = ''
if accountName is not '':
    userData = c.listSpecificUser(accountName)
else:
