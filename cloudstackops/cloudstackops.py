...
class CloudStackOps(CloudStackOpsBase):
    ...
    def initCloudStackAPI(self):
        ...
        if log is None or log == '':
            print "==why the hell log is enmpty"
        print "all good so far"
        try:
            # mgmtDet = mgtServer()
            # print "initializing"
            # mgmtDet.apiKey = self.apikey
            # print mgmtDet.apiKey
            # mgmtDet.securitykey = self.secretkey
            # mgmtDet.mgtSvrIp = self.apiserver
            # mgmtDet.port = int(self.apiport)
            # mgmtDet.user = "admin"
            # mgmtDet.passwd = "password"
            # mgmtDet.useHttps = False
            # print "===== url is " + self.apiurl
            # self.cloudstack = CSConnection(mgmtDet=mgmtDet, asyncTimeout=14400, logger=log, path=self.apiurl)
    ...
    def _callAPI(self, apicall):
        ...
        try:
            #data = self.cloudstack.marvinRequest(apicall, response_type="json")
    ...
    def listVirtualmachines(self, args):
        ...
        apicall.id = (
            str(args['id'])) if 'id' in args else None
    ...
    def updateVirtualMachine(self, args):
        ...
        apicall = updateVirtualMachine.updateVirtualMachineCmd()
        apicall.displayname = (args['displayname']) if 'displayname' in args else None
    ...
    def listSecurityGroups(self, args):
        ...
        apicall = listSecurityGroups.listSecurityGroupsCmd()
        apicall.virtualmachineid = (args['virtualmachineid']) if 'virtualmachineid' in args else None
        apicall.listAll = (args['listAll']) if 'listAll' in args else 'true'
        apicall.id = (str(args['id'])) if 'id' in args else None
        apicall.keyword = (args['keyword']) if 'keyword' in args else None
        apicall.securitygroupname = (args['securitygroupname']) if 'securitygroupname' in args else None
        apicall.domainid = (args['domainid']) if 'domainid' in args else None

        # Call CloudStack API
        return self._callAPI(apicall)

    def updateSecurityGroup(self, args):
        args = self.remove_empty_values(args)

        apicall = updateSecurityGroup.updateSecurityGroupCmd()
        apicall.id = (str(args['id'])) if 'id' in args else None
        apicall.name = (args['name']) if 'name' in args else None
    ...
    # upgrading domain resources
    def updateResourceLimit(self, args):
        apicall = updateResourceLimit.updateResourceLimitCmd()
        apicall.domainid = str(args['domainid']) if 'domainid' in args else None
        apicall.resourcetype = args['resourcetype'] if 'resourcetype' in args else None
        apicall.max = str(args['resourcevalue']) if 'resourcevalue' in args else None

        return self._callAPI(apicall)

    def updateResourceCount(self, args):
        apicall = updateResourceCount.updateResourceCountCmd()
        apicall.domainid = str(args['domainid']) if 'domainid' in args else None

        return self._callAPI(apicall)

    # Stop virtualvirtualmachine
    def stopVirtualMachine(self, vmid, force="false"):
    ...
    # Reboot virtualvirtualmachine
    def rebootVirtualMachine(self, vmid):
        apicall = rebootVirtualMachine.rebootVirtualMachineCmd()
        apicall.id = str(vmid)
    ...
    def deployVirtualMachine(self, args):
        ...
        apicall.securitygroupids = (
            str(args['securitygroupids'])) if 'securitygroupids' in args else None
        apicall.affinitygroupids = (
            str(args['affinitygroupids'])) if 'affinitygroupids' in args else None
        apicall.diskofferingid = (
            str(args['diskofferingid'])) if 'diskofferingid' in args else None
        apicall.displayvm = (str(args['displayvm'])) if 'displayvm' in args else True
        apicall.zoneid = (str(args['zoneid'])) if 'zoneid' in args else None
        ...
        apicall.startvm = (str(args['startvm'])) if 'startvm' in args else False
        apicall.keypair = (str(args['keypair'])) if 'keypair' in args else None
    ...
    def destroyVirtualMachine(self, vmid):
        ...
        apicall.id = vmid
        apicall.expunge = "false"

        # Call CloudStack API
        return self._callAPI(apicall)

    # Expunge VM
    def expungeVirtualMachine(self, vmid):
        apicall = destroyVirtualMachine.destroyVirtualMachineCmd()
        apicall.id = vmid
  ...
  # list networkOfferings (all or one)
    ...
    def createTemplate(self, args):
        apicall = createTemplate.createTemplateCmd()
        apicall.displaytext = str(args['displaytext']) if 'displaytext' in args else None
        apicall.name = str(args['name']) if 'name' in args else None
        apicall.ostypeid = str(args['ostypeid']) if 'ostypeid' in args else None
        apicall.volumeid = str(args['volumeid']) if 'volumeid' in args else None

        return self._callAPI(apicall)

    # list specific user
    def listSpecificUser(self, keyword):
        domainData = {}
        apicall = listUsers.listUsersCmd()
        apicall.listAll = "true"
        ...
        # Call Cloudstack API
        domainUser = self._callAPI(apicall)
        domainData[domainUser[0].domainid] = []
        domainData[domainUser[0].domainid].append(domainUser)
        return domainData
    ...
    def createAccount(self, args):
        apicall = createAccount.createAccountCmd()
        apicall.username = args['username'] if 'username' in args else None
        apicall.domainid = args['domainid'] if 'domainid' in args else None
