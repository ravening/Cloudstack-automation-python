...
Currently, this tool integrates (is dependent) of other support and monitoring tools, mostly using them in the so-called "quick" mode (default). To perform a live assessment, there is a --live switch.
...
There is extensive documentation, but to be simplify the documentation we will now start documenting the check and repair support in the tool itself. To see the list of tests and 
